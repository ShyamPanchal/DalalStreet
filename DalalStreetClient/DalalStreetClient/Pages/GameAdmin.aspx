           ...
           <p>
               <asp:ScriptManager ID="ScriptManager" runat="server" />
                ...
                <asp:UpdatePanel ID="PlayerTablePanel" runat="server" UpdateMode="Conditional">
                    ...
                    <ContentTemplate>
                        <asp:table id="Table" runat="server" GridLines="Horizontal" HorizontalAlign="Center" Width="75%" CssClass="w3-table w3-centered w3-bordered w3-hoverable w3-text-black w3-white w3-round-large">
